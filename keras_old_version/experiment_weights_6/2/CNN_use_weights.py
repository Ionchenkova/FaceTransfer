...
if __name__ == '__main__':
    ...
    train(model=autoencoder, train_data_x=own_train_data_x, train_data_y=own_train_data_x, test_data=own_test_data, nb_epoch=500)
    train(model=autoencoder, train_data_x=own_test_data, train_data_y=own_train_data_x, test_data=own_test_data, nb_epoch=10)
    train(model=autoencoder, train_data_x=own_train_data_x, train_data_y=own_test_data, test_data=own_train_data_x, nb_epoch=10)
    train(model=autoencoder, train_data_x=own_test_data, train_data_y=own_train_data_x, test_data=own_train_data_x, nb_epoch=10)
